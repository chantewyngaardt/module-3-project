...
-- create table register_customer_users(
-- user_id int auto_increment primary key,
-- first_name varchar(255),
-- last_name varchar(255),
-- email varchar(255),
-- create_password varchar(100),
-- confirm_password varchar(100)
-- );

-- create table login_customer_user(
-- email varchar(150),
-- password varchar(100)
-- );

-- insert into register_customer_users(user_id,first_name,last_name,email,create_password,confirm_password)
-- values();

-- insert into login_customer_user(email,password)
-- values();
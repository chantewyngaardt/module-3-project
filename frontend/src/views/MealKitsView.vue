...
export default {
    ...
    return {
      mealKits: [
          ...
          },
          {
            ...
            meal_description:
              "Make your own tacos with a mix of soft and hard shells, spiced beef, and fresh toppings.",
            price: 99.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Soft tortillas, hard taco shells, ground beef, taco seasoning, lettuce, tomatoes, cheese, sour cream, salsa",
            calories: 650,
            dietary_info: "Contains dairy, gluten; halal-certified",
            image_url:
              "https://thebakermama.com/wp-content/uploads/2022/03/IMG_0389-scaled.jpg",
            stock_quantity: 30,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "Corn tortillas filled with seasoned chicken and covered in a flavorful enchilada sauce.",
            price: 109.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Corn tortillas, shredded chicken, enchilada sauce, cheese, sour cream, cumin, chili powder",
            calories: 700,
            dietary_info: "Contains dairy; halal-certified",
            image_url:
              "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_1:1/k%2FPhoto%2FRecipes%2F2024-05-mexican-enchiladas%2Fmexican-enchiladas-435",
            stock_quantity: 30,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "A crispy, cheesy quesadilla with steak and fresh toppings.",
            price: 94.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Flour tortillas, cheese, grilled steak, onions, bell peppers, sour cream, salsa",
            calories: 680,
            dietary_info: "Contains dairy, gluten; halal-certified",
            image_url:
              "https://cdn.loveandlemons.com/wp-content/uploads/2024/01/quesadilla-500x500.jpg",
            stock_quantity: 35,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "Sizzling marinated steak fajitas with bell peppers and onions, served with warm tortillas.",
            price: 109.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Flour tortillas, marinated steak, bell peppers, onions, fajita seasoning, sour cream, salsa",
            calories: 730,
            dietary_info: "Contains dairy, gluten; halal-certified",
            image_url:
              "https://theyummybowl.com/wp-content/uploads/TYB-FEATURED-1.jpg",
            stock_quantity: 30,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "A simple and filling burrito bowl with rice, beans, and chicken.",
            price: 94.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Rice, black beans, grilled chicken or beef, salsa, cheese",
            calories: 700,
            dietary_info: "Contains dairy; gluten-free",
            image_url:
              "https://feelgoodfoodie.net/wp-content/uploads/2023/09/Chicken-Burrito-Bowl-TIMG.jpg",
            stock_quantity: 35,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "Fresh homemade salsa and guacamole served with crispy tortilla chips.",
            price: 74.99,
            category: "meal-kit",
            cuisine: "Mexican",
            ingredients:
              "Tomatoes, avocados, lime, garlic, onions, tortilla chips, cilantro",
            calories: 450,
            dietary_info: "Vegan; gluten-free",
            image_url:
              "https://www.thedailymeal.com/img/gallery/roasted-garlic-guacamole-with-homemade-air-fryer-tortilla-chips/guac-chips.jpg",
            stock_quantity: 50,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "Enjoy a comforting bowl of ramen with fresh noodles, miso broth, and classic toppings.",
            price: 99.99,
            category: "meal-kit",
            cuisine: "Asian",
            ingredients:
              "Fresh ramen noodles, miso paste, soy sauce, spring onions, nori, boiled egg, sesame seeds",
            calories: 550,
            dietary_info: "Contains gluten; halal-certified",
            image_url:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIh00BItzuOQQi-CYYGXL_LbY-nwbV9h0Fpg&s",
            stock_quantity: 30,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "A rich and hearty lasagna with layers of pasta, tomato sauce, minced beef, and creamy cheese.",
            price: 139.99,
            category: "meal-kit",
            cuisine: "Italian",
            ingredients:
              "Lasagna sheets, tomato sauce, minced beef, mozzarella cheese, onion, garlic, béchamel sauce",
            calories: 820,
            dietary_info: "Contains gluten, dairy",
            image_url:
              "https://static01.nyt.com/images/2023/08/31/multimedia/RS-Lasagna-hkjl/RS-Lasagna-hkjl-googleFourByThree-v2.jpg",
            stock_quantity: 35,
            created_at: "CURRENT_TIMESTAMP",
          },
          {
            ...
            meal_description:
              "Soft potato gnocchi served with a creamy parmesan sauce or a light tomato sauce.",
            price: 109.99,
            category: "meal-kit",
            cuisine: "Italian",
            ingredients:
              "Potato gnocchi, parmesan cheese, garlic, olive oil, tomato sauce",
            calories: 650,
  ...
  computed:{
    filteredProducts(){
      return this.mealKits.filter(item=>item.dietary_info.includes(this.selectedDiet) && item.cuisine.includes(this.selectedCuisine) )
    }
  },
  mounted() {},
};
